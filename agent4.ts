...
const longMessages1 = response1.messages[response1.messages.length-1].content
console.log(longMessages1);
...
const longMessages2 = response2.messages[response2.messages.length-1].content
console.log(longMessages2);
